...
class FSDet(model_base.ModelBase):
  """FSDet model to provide instance-level annotations. """

  def __init__(self, options, is_training):
    """Constructs the FSDet instance. """
    if not isinstance(options, model_pb2.FSDet):
      raise ValueError('Options has to be an FSDet proto.')
    super(FSDet, self).__init__(options, is_training)
